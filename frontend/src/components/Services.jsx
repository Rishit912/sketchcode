...
const Services = () => {
  return (
    // Outer animation wrapper for the entire section (Slide Up)
    <AnimateOnScroll duration="duration-1000" direction="up">
      ...
      >
        <div className="container mx-auto px-6 lg:px-12">
          ...
          {/* Main Title/Intro Block - Slide Down */}
          <AnimateOnScroll duration="duration-1000" delay={100} direction="down">
          ...
          {/* Services Cards - Alternating Left/Right Slide, Slow Duration */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16 items-stretch">
            {services.map((service, index) => (
              <AnimateOnScroll
                ...
                // Staggered delay + Alternating direction
                delay={index * 250 + 200}
          ...
          {/* CTA Block - Slide Down */}
          <AnimateOnScroll delay={500} duration="duration-1000" direction="down">
