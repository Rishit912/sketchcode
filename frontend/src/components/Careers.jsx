...
const Careers = () => {
  return (
    // Outer wrap for the entire section (slow, smooth entry)
    <AnimateOnScroll duration="duration-1000"> 
      <section id="careers" className="relative z-10 bg-gray-900/95 text-gray-200 py-16 md:py-24 min-h-screen border-b-4 border-gray-700">
        <div className="container mx-auto px-6 lg:px-12">
          ...
          {/* 1. WHY JOIN / PERKS / HIRE Process Cards (Staggered Animation) */}
          ...
          {/* 2. WHY JOIN FEATURE GRID (Staggered Animation) */}
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              {[
                ...
                <AnimateOnScroll key={index} delay={index * 100} duration="duration-500">
                  <div className="bg-gray-800 p-8 rounded-2xl shadow-xl transform transition-transform duration-300 hover:scale-105 border border-gray-700">
          ...
          {/* 3. CTA Block (Animated separately for emphasis) */}
